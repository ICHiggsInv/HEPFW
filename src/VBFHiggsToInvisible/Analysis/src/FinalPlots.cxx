...
void hepfw::FinalPlots::beginJob(hepfw::JobSetup &job){
  ...
  m_sigWel_Dijet_Mjj             = new TH1D("sigWta_Dijet_Mjj",            "Dijet_Mjj",                  19,1200,3100); m_sigWel_Dijet_Mjj              ->SetDirectory(thisDir);
  m_sigWel_metNoMuon             = new TH1D("sigWta_metNoMuon",            "metNoMuon",                    21,90, 575); m_sigWel_metNoMuon              ->SetDirectory(thisDir);
  m_sigWel_MinDeltaPhiMetAllJets = new TH1D("sigWta_MinDeltaPhiMetAllJets","MinDeltaPhiMetAllJets",22,2.3,TMath::Pi()); m_sigWel_MinDeltaPhiMetAllJets->SetDirectory(thisDir);;
  
  m_sigWmu_Dijet_Mjj             = new TH1D("sigWta_Dijet_Mjj",            "Dijet_Mjj",                  19,1200,3100); m_sigWmu_Dijet_Mjj              ->SetDirectory(thisDir);
  m_sigWmu_metNoMuon             = new TH1D("sigWta_metNoMuon",            "metNoMuon",                    21,90, 575); m_sigWmu_metNoMuon              ->SetDirectory(thisDir);
  m_sigWmu_MinDeltaPhiMetAllJets = new TH1D("sigWta_MinDeltaPhiMetAllJets","MinDeltaPhiMetAllJets",22,2.3,TMath::Pi()); m_sigWmu_MinDeltaPhiMetAllJets->SetDirectory(thisDir);;
